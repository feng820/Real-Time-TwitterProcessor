...
def main():
    # load
    nfeeling_words = load_word_list("/home/linfengwork820/spark/Dataset/nFeeling.txt")
    pfeeling_words = load_word_list("/home/linfengwork820/spark/Dataset/pFeeling.txt")
